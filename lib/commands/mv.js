...
module.exports = function() {
    ...
    return this
        ...
        .opt()
            .name('cherryPick')
            .title('cherry pick specified entity only, without its contents')
        ...
        .act(function(opts, args) {
            ...
            if  (sameTech && U.bemKey(source) === U.bemKey(target) && sourceLevel.dir === targetLevel.dir) {
            ...
            if (U.bemType(source) === U.bemType(target)) {
                ...
                if (!sameTech) {
                    target.tech = target.techs.join('');
                    target.suffix = '.' + target.tech;
                }
